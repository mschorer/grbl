...
//----------------------------------------------------------------------------------------
	...
	// status display LED
	#define TIMER_LED_PERI	SYSCTL_PERIPH_TIMER2
	#define TIMER_LED_PORT	TIMER2_BASE
    ...
    #define TIMER_I2C_PERI	SYSCTL_PERIPH_TIMER3
	#define TIMER_I2C_BASE	TIMER3_BASE
    #define TIMER_I2C_vect	INT_TIMER2A
