...
OBJECTS    = main.o motion_control.o gcode.o spindle_control.o coolant_control.o serial.o \
             ...
             print.o probe.o report.o system.o status.o i2c_master.o tool_control.o machine_control.o
...
COMPILE = avr-gcc -Wall -Os -DF_CPU=$(CLOCK) -mmcu=$(DEVICE) -I. -fstack-usage -ffunction-sections
