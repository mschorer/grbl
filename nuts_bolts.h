...
/*
#define GLOBAL_SYS_EXECUTE GPIOR0

#define bit_true_atomic(x,mask) { GLOBAL_SYS_EXECUTE |= (mask);	}
#define bit_false_atomic(x,mask) { GLOBAL_SYS_EXECUTE &~(mask);	}
#define bit_toggle_atomic(x,mask) { GLOBAL_SYS_EXECUTE ^= (mask); }
*/
